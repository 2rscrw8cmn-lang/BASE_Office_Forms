...
**Status: complete** — PR #47 is merged to `main` as `315de55`. See
`docs/UI_PROGRAM_STATUS.md` §5F. The prompt below is retained as the phase's
...
mobile filter disclosure, and the retained legacy rollback modules.
